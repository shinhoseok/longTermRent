...
<div class="header_centerBox">
	<h1 style="cursor: pointer;" onclick="${basePath}/login/a/login.do">
			...
			<ul id="navi">
				<c:choose>
					<c:when test="${alevel eq '1' }">
						<li id="menu" class="selectMenu"><a href="${basePath }/login/z/selectIdSearch.do">아이디 찾기</a></li>
						<li id="menu"><a href="${basePath }/login/z/selectPwdSearch.do">비밀번호 찾기</a></li>
					</c:when>
					<c:when test="${alevel eq '2' }">
						<li id="menu"><a href="${basePath }/login/z/selectIdSearch.do">아이디 찾기</a></li>
