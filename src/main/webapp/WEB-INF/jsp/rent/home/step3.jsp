...
<section>
	<article>
		...
		<div class="text_box">
			<img src="${imagePath}/q3.png" class="img_q1">
...
<form:form commandName="visitorVO" action="/home/a/selectMainStep4.do" name="visitorVO" id="visitorVO" method="post">
	<form:hidden path="qtnId" id="qtnId"/>
	<form:hidden path="asrId" id="asrId"/>
</form:form>
<script type="text/javascript">
var fn_selectMainStep = function(qtnId, asrId) {
	var atnIdSum = $("#qtnId").val();
	var asrIdSum = $("#asrId").val();
	atnIdSum = atnIdSum + "," + qtnId;
	asrIdSum = asrIdSum + "," + asrId;
	$("#qtnId").val(atnIdSum);
	$("#asrId").val(asrIdSum);
	$("#visitorVO").submit();
};
